...
{
    /// <inheritdoc />
    public partial class InitialScenarioSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Countries_Platforms_PlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Territories_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Territories_TerritoryId",
                        column: x => x.TerritoryId,
                        principalTable: "Territories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingRequests_Sites_SiteId",
                        column: x => x.SiteId,
                        principalTable: "Sites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrainingRequestId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditEvents_TrainingRequests_TrainingRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecidedById = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestDecisions_TrainingRequests_TrainingRequestId",
                        column: x => x.TrainingRequestId,
                        principalTable: "TrainingRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestMessages_TrainingRequests_TrainingRequestId",
                        column: x => x.TrainingRequestId,
                        principalTable: "TrainingRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TerritoryId",
                table: "AspNetUsers",
                column: "TerritoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditEvents_TrainingRequestId",
                table: "AuditEvents",
                column: "TrainingRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Countries_PlatformId",
                table: "Countries",
                column: "PlatformId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestDecisions_TrainingRequestId_Action",
                table: "RequestDecisions",
                columns: new[] { "TrainingRequestId", "Action" },
                unique: true,
                filter: "[Action] IN ('Approved','Declined')");

            migrationBuilder.CreateIndex(
                name: "IX_RequestMessages_TrainingRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingRequests_RequestNumber",
                table: "TrainingRequests",
                column: "RequestNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainingRequests_SiteId",
                table: "TrainingRequests",
                column: "SiteId");
        }
